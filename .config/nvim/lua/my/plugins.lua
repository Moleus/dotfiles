...
return require('packer').startup(function(use)
    ...
    -- use 'lyokha/vim-xkbswitch'          -- Change layout on Escape/Insert mode
    ...
    -- use 'vim-syntastic/syntastic'                          -- syntax highlighting
    -- use 'ervandew/supertab'                                -- peace YCM with Ultisnips
